...
data %>% select("Green Building Verification", "Green Energy Efficient", "Green Sustainability", "Accessibility Features", "Homeowner 
  Association", "Occupant Type", "Patio & Porch Features", "Security Features") %>%
